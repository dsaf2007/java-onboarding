...
class Problem1 {
    ...
    public static int solution(List<Integer> pobi, List<Integer> crong) {
        ...
        // pobiScore = Math.max(getMaxCalc(pobi.get(0).intValue()),
        // getMaxCalc(pobi.get(1).intValue()));
        // crongScore = Math.max(getMaxCalc(crong.get(0).intValue()),
        // getMaxCalc(crong.get(1).intValue()));
